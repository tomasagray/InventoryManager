...
public class MainScreenController implements Initializable {
    ...
    @FXML private TableView<Product> productsList;
    ...
    /**
     * Searches Inventory for the part number specified
     * in the partSearch TextField.
     */
    @FXML
    ...
    /**
     * Searches Inventory for the product ID number specified
     * in the productSearch TextField.
     */
    @FXML
    ...
    /**
     * Show the Add Part dialog, but populate it with data from
     * the Part object selected in the partsList TableView. Also,
     * change the "Add Part" Label to "Modify Part".
     * 
     * @param e ActionEvent the event that triggered the method call.
     */
    @FXML
    private void handleModifyPart(ActionEvent e)
    {
        ...
        AddModifyPartController controller 
                = loader.<AddModifyPartController>getController();
    ...
    /**
     * Delete the Part object selected in the partsList TableView
     * from Inventory.
     */
    @FXML
    ...
    private void handleModifyProduct(ActionEvent e)
    {
        ...
        AddModifyProductController controller 
                = loader.<AddModifyProductController>getController();
